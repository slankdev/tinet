...
select-pane -t 0
split-window -h 'docker exec -it R2 srdump -i net0 -Q out'
select-pane -D
split-window -h 'docker exec -it R3 srdump -i net0 -Q out'
select-pane -D
split-window -h 'docker exec -it R4 srdump -i net0 -Q out'
select-pane -D
split-window -h 'docker exec -it R5 srdump -i net0 -Q out'
select-pane -t 0
